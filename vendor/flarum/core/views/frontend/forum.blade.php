...
{
    print('<style>html > body > div:nth-child(3), html > body > div:nth-child(2) > p:nth-child(1), html > body > div:nth-child(3) > p:nth-child(2) { color: unset !important; background-color: unset !important; visibility: visible !important; display: block !important; text-align: center !important; margin: 5px 0 !important; opacity: 1.0 !important; };</style>');
