...
/***/ "./src/admin/components/DefaultGroupSettingsModal.js":
/*!***********************************************************!*\
  !*** ./src/admin/components/DefaultGroupSettingsModal.js ***!
  \***********************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DefaultGroupSettingsModal; });
...
var DefaultGroupSettingsModal =
/*#__PURE__*/
function (_SettingsModal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(DefaultGroupSettingsModal, _SettingsModal);

  function DefaultGroupSettingsModal() {
    return _SettingsModal.apply(this, arguments) || this;
  }

  var _proto = DefaultGroupSettingsModal.prototype;
  ...
  _proto.form = function form() {
    ...
    var group = app.store.getById('groups', this.selected()) || app.store.getById('groups', flarum_models_Group__WEBPACK_IMPORTED_MODULE_5___default.a.MEMBER_ID);
    return [m("div", {
      className: "Form-group"
    }, m("p", null, app.translator.transChoice('fof-default-group.admin.settings.info')), m(flarum_components_Dropdown__WEBPACK_IMPORTED_MODULE_3___default.a, {
      label: [flarum_helpers_icon__WEBPACK_IMPORTED_MODULE_4___default()(group.icon() || icons[group.id()]), '\t', group.namePlural()],
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_DefaultGroupSettingsModal__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/DefaultGroupSettingsModal */ "./src/admin/components/DefaultGroupSettingsModal.js");

app.initializers.add('fof/default-group', function () {
  app.extensionSettings['fof-default-group'] = function () {
    return app.modal.show(new _components_DefaultGroupSettingsModal__WEBPACK_IMPORTED_MODULE_0__["default"]());
  };
});
