                    ...
                    <form onsubmit={this.onsubmit.bind(this)}>
                        ...
                        {FieldSet.component({
                            ...
                            <div className="WordConfigPage-Settings-input">
                                ...
                                <textarea className="FormControl" placeholder={app.translator.trans('fof-filter.admin.input.placeholder')} rows="6" value={this.values.words() || null} oninput={withAttr('value', this.values.words)}/>
                            </div>
                        ])}
                        {FieldSet.component({
                            ...
                            <div className="WordConfigPage-Settings-input">
                                ...
                                <input className="FormControl" value={this.values.flaggedSubject() || app.translator.trans('fof-filter.admin.email.default_subject')} oninput={withAttr('value', this.values.flaggedSubject)}/>
                                <label>{app.translator.trans('fof-filter.admin.input.email_body')}</label>
                                <div className="helpText">
                                    {app.translator.trans('fof-filter.admin.email_help')}
                                </div>
                                <textarea className="FormControl" rows="4" value={this.values.flaggedEmail() || app.translator.trans('fof-filter.admin.email.default_text')} oninput={withAttr('value', this.values.flaggedEmail)}/>
                            </div>
                        ])}
                        {Switch.component({
                        ...
                        <input className="FormControl" value={this.values.cooldown()} type="number" oninput={withAttr('value', this.values.cooldown)}/>
                        <div className="helpText">
